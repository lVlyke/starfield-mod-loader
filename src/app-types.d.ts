...
declare type AppProfileModVerificationResult = import("./app/models/app-profile").AppProfileModVerificationResults;
...
declare type AppProfileExternalFiles = import("./app/models/app-profile").AppProfileExternalFiles;
